...
export class Backend implements backendInterface {
    ...
    async getAllParticipants(arg0: string): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllParticipants(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllRoomStates(): Promise<Array<RoomState>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllRoomStates();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRoomState(arg0: string): Promise<RoomState> {
        if (this.processError) {
            try {
    ...
    async joinRoom(arg0: string, arg1: string): Promise<RoomState> {
        if (this.processError) {
            try {
    ...
    async setVideoSource(arg0: {
        videoSource: string;
        roomCode: string;
    }): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setVideoSource(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePlaybackState(arg0: {
        isPlaying: boolean;
        position: number;
        roomCode: string;
    }): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePlaybackState(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
